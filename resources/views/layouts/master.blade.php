<html>
    ...
    <body>
        ...
        <!-- Navbar brand -->
        <a class="navbar-brand" href="{{url('/')}}"><img src="{{url('lareview.png')}}" width="200" alt=""></a>
        ...
        <div class="collapse navbar-collapse justify-content-between" id="basicExampleNav">
          ...
          <ul class="navbar-nav">
            ...
            @auth 
                <li class="nav-item">
                <a class="nav-link" href="{{url('movie')}}">Películas</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="{{url('genre')}}">Géneros</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="{{url('person')}}">Personas</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                <form id="logout" action="{{url('/logout')}}" method="POST" style="margin:0">
                    @csrf
    ...
    <footer class="page-footer font-small primary-color bg-primary text-white">
        ...
        <div class="footer-copyright text-center py-2" >
            <a href="https://github.com/luisdavidfer/lareview"><img class="mb-2 pt-1" src="{{url('lareview.png')}}" width="100" alt="La review"></a> © 2019
